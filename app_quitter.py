...
SYMBOL = u"\u2764\ufe0f"
# put your company's name here for the farewell that comes after the SYMBOL
CORPORATEBRANDING = "Your Company's Name IT Department"
...
def force_quit_prompt(prompt):
    ...
    icon = "~/Library/Application\ Support/com.jamfsoftware.selfservice.mac/Documents/Images/brandingimage.png"
